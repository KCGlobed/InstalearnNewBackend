...
urlpatterns = [
    ...
    path('get-payment-setting/', GetPaymentSettingView.as_view(), name="get-payment-setting"),
    path('update-payment-setting/', UpdatePaymentSettingView.as_view(), name="update-payment-setting"),
